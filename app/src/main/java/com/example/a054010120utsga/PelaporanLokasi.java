...
public class PelaporanLokasi extends AppCompatActivity implements FetchAddressTask.OnTaskCompleted {
    // Constants
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pelaporan_lokasi);
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(PelaporanLokasi.this);
        ...
        mLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (nama_lengkap.getText().toString().isEmpty()) {
                    Toast.makeText(PelaporanLokasi.this, "Masukkan Nama Anda", Toast.LENGTH_SHORT).show();
                } else if (no_whatsapp.getText().toString().isEmpty()) {
                    Toast.makeText(PelaporanLokasi.this, "Masukkan No. WhatsApp", Toast.LENGTH_SHORT).show();
                } else {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation) {
                    new FetchAddressTask(PelaporanLokasi.this, PelaporanLokasi.this).execute(locationResult.getLastLocation());
                }
            }
        };
        return;
            ...
            mFusedLocationClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (!(location == null)) {
                        ...
                        Toast.makeText(PelaporanLokasi.this, "Aktifkan Lokasi", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(PelaporanLokasi.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                }
            });
