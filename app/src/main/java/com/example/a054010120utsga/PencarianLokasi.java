...
public class PencarianLokasi extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(PencarianLokasi.this, "Your Current Location", Toast.LENGTH_LONG).show();
